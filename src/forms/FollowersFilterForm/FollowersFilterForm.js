  ...
  return (
    <FinalForm
      ...
      render={formRenderProps => {
        ...
        const clear = intl.formatMessage({ id: 'FollowersFilterForm.clear' });
        const cancel = intl.formatMessage({ id: 'FollowersFilterForm.cancel' });
        const submit = intl.formatMessage({ id: 'FollowersFilterForm.submit' });
...
const FollowersFilterForm = injectIntl(PriceFilterFormComponent);

export default FollowersFilterForm;
