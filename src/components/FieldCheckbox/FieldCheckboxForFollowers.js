...
const FieldCheckboxForFollowersComponent = props => {
  const {
    rootClassName,
    className,
    svgClassName,
...
console.log(com)
  ...
  return (
    <span className={classes}>
      <Field  checked={done} onChange={funt} {...checkboxProps} />
...
FieldCheckboxForFollowersComponent.defaultProps = {
  className: null,
  rootClassName: null,
  svgClassName: null,
  textClassName: null,
...
FieldCheckboxForFollowersComponent.propTypes = {
  className: string,
...
export default FieldCheckboxForFollowersComponent;
