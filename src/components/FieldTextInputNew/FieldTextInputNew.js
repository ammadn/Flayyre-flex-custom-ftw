...
class FieldTextInputNewComponent extends Component {
  render() {
...
FieldTextInputNewComponent.defaultProps = {
  rootClassName: null,
  className: null,
  inputRootClass: null,
  onUnmount: null,
...
FieldTextInputNewComponent.propTypes = {
...
class FieldTextInputNew extends Component {
  ...
  render() {
    return <Field  component={FieldTextInputNewComponent} {...this.props} />;
  }
}
